  ...
  const savePin = () => {
    if (title && about && destination && imageAsset?._id && category) {
      ...
      client.create(doc).then(() => {
        Swal.fire({
          title: "Post Created",
          text: "You can see your post in the home page",
          ...
          <div className="flex flex-col">
            ...
            <div className="flex justify-end items-end mt-5">
              <button
                ...
                font-bold rounded-md w-28 outline-none p-2 hover:shadow-md hover:bg-red-900 duration-150 transition-all ease-in-out"
              >
                Save Post
              </button>
            </div>
